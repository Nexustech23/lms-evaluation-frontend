    ...
    pollTimerRef.current = setTimeout(async () => {
      try {
        const res = await axios.get(
          `${API_BASE}/api/ai-tutor/generate-notes/status/${jobId}`
        );
    ...
    try {
      ...
      if (!prompt && !file) {
        ...
        toast.error(
          ...
          "Please enter notes details or upload study material."
        );
      ...
      const response =
        await axios.post(
          ...
          `${API_BASE}/api/ai-tutor/generate-notes`,
...
`}
        ...
        {loading && (
          ...
          <LoadingState
            ...
            subtitle="
            AI is analyzing your study material and preparing smart notes.
            "
        ...
        {!loading && (
          ...
          <OutputPreview
            ...
            emptyMessage="
            Your AI-generated notes preview will appear here.
            "
