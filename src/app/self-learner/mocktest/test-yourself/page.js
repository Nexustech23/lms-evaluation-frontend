    ...
    <div className="flex flex-col min-h-screen" style={{ backgroundColor: color }}>
      <div className="flex-1 p-4 sm:p-6">
        ...
        <div className="bg-white rounded-2xl shadow-sm px-5 py-4 flex flex-wrap items-center justify-between gap-3 mb-4">
          <div>
            <h2 className="text-xl font-bold" style={{ color }}>My Practice Tests</h2>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={() => router.push("/self-learner/mocktest/create-test")}
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-2xl shadow-sm">
            <EmptyListState
              color={color}
              onCreate={() => router.push("/self-learner/mocktest/create-test")}
            />
          </div>
        ) : (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {filtered.map((test) => (
              <TestCard
                ...
                test={test}
                color={color}
                onAttempt={(id) => router.push(`/self-learner/mocktest/test-yourself/${id}`)}
