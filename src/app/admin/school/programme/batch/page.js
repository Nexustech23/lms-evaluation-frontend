  ...
  {(pagination.page - 1) *
    ...
    1}
                    ...
                    <td className="px-5 py-4">
                      <span className={`px-2.5 py-1 ${user?.color?"bg-green-50 border-green-200":"bg-orange-50 border-orange-200"} border rounded-full text-xs font-semibold`}
            ...
            <div className="px-6 py-5">
              ...
              <div className="mb-6">
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  {t("batch_name_label")} <span className="text-red-500">*</span>
                </label>
                <input
                  ...
                  <div key={semIndex} className="border border-gray-200 rounded-xl mb-4 overflow-hidden">
                    ...
                    <div className="p-4 space-y-2">
                      ...
                      <button
                        ...
                        className={`mt-2 text-xs border px-3 py-1.5 rounded-lg transition font-medium ${user?.color?"hover:text-green-700 border-green-200 bg-green-50 hover:bg-green-100 ":"hover:text-orange-700 border-orange-200 bg-orange-50 hover:bg-orange-100 "}`}
                        style={{color: user?.color || "#ff7f10"}}
                      >
                       {t("add_subject")}
                      </button>
              ...
              <button
                onClick={addSemester}
                className={`w-full py-2.5 border-2 border-dashed rounded-xl text-sm font-medium transition ${user?.color?"border-green-300 text-green-600 hover:bg-green-50":"border-orange-300 text-orange-600 hover:bg-orange-50"}`}
              >
               {t("add_semester")}
              </button>
